...
export class Utils {
     ...
     * @param o 
     */
    static cloneObj(o: object): object {
        let obj = {};
        for (let prop in o) {
            obj[prop] = o[prop];
        }
  ...
  */
    ...
    static getZeroDataeTime(): Date {
        let zeroDataeTime = new Date(new Date().toLocaleDateString() + ' ' + "00:00");
        return zeroDataeTime;
    }
    ...
    */
     ...
     * @param s 
     */
    static clearBadgeId(badgeId: string): string {
        return badgeId.trim().replace(/\b(0+)/gi, "");
    }
